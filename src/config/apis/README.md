 ...
 * @LastEditors: zhoukai
 * @LastEditTime: 2022-10-20 14:15:46
-->
...
```
├─ apis
│  ├─ dev.ts                                     //功能接口，为了方便维护与开发，建议接口文件命名与对应的页面文件命名保持一致，尽量简洁明了。
│  ├─ README.md                                  //描述文件
│  └─ validation                                 //验证器
│     ├─ getListDev.ts                           //对应接口的验证器，为了方便维护与开发，建议接口文件命名与对应的接口命名保持一致，尽量简洁明了。
│     └─ index.ts                                //统一导出验证器（需要在这里将你的接口验证器统一导出）
```
